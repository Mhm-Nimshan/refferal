                     ...
                     <div className="row align-items-start">
                        <div className="col-6">
                           <div className="header-top__link">
                              <span>Invest Smart With Digital Assets</span>
                              <Link href="https://www.amezhub.com/">
                        ...
                        <div className="col-6">
                           <div className="header-top__support text-end">
                              <span>Get Support: <Link href="https://wa.me/15409000666">+1 (540) 900 0666</Link></span>
                           </div>
                        </div>
                     </div>
                  </div>
                           ...
                           <div className="header-bottom__right d-flex align-items-center justify-content-end">
                              <div className="header-bottom__btn d-flex align-items-center">
                                 <Link className="tp-btn-white tp-btn-hover alt-color-black d-none d-md-inline-block" href="/service-details">
                                    <span className="white-text">Refer Now</span>
                                    <b></b>
                                 </Link>
