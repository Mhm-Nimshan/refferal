...
import account_img_3 from "../../../../public/assets/img/account/ac-author.svg"
...
const account_content ={
    ...
    account_step: [
        ...
        },
        {
            id: 3, 
            number: "03",
            info: <>Your account is ready, you can send <br /> your first payment</>,
        },

    ],
    btn_text: "Open An Account in Minutes",
    info: "Amez Hub users can login to the wallet directly using their Amez ID",
}
...
const OpenAccountArea = () => {
    return (
      <>
        <div className="tp-account-area pb-70">
              ...
              <div className="col-xl-6 col-lg-6">
                <div className="tp-account-step-wrapper">
                  ...
                  <div className="tp-account-btn-box">
                    <Link className="tp-btn-green mb-15" href="#">
                      {btn_text}
                    </Link>
                    <p>{info}</p>
                  </div>
