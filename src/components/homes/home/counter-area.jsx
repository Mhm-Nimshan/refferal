...
const counter_content = {
    counter_info: [
        {id: 1, counter: 10, counter_icon: <><em></em>M+</>,  title: "Total Funding",  },
        {id: 2, counter: 100, counter_icon: <><em></em>K+</>,  title: "Total Active Users",  },
        {id: 3, counter: 300, counter_icon: <><em></em>+</>,  title: "Team Members",  },
    ],
} 
      ...
      <>
        <div className="tp-counter-area tp-counter-space p-relative pb-140">
          <div className="tp-counter-shape-2">
            <Image src={counter_shape_1} alt="amez-image" />
          </div>
          <div className="tp-counter-shape-3">
            <Image src={counter_shape_2} alt="amez-image" />
          </div>
          <div className="tp-counter-shape-4 d-none d-sm-block">
            <Image src={counter_shape_3} alt="amez-image" />
          </div>
